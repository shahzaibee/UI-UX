    ...
    <div className="pt-4 lg:pt-10">
      <div className="px-[20px] lg:px-[280px]">
        ...
        <div className="flex w-full pt-8 justify-center gap-x-6">
          ...
          <button className="w-1/2 text-[#4328EB] flex justify-center items-center gap-x-2 lg:w-fit">
            View Pricing{" "}
            <span>
              <Image src={BlueArrow} alt="Learn more" priority/>
            </span>
          </button>
        </div>
      </div>
      <div className="relative h-full w-full justify-center ">
        <Image
          src={Gradient}
          alt="Gradient"
          className="min-h-[500px] object-cover w-full lg:h-auto"
        />
        <div className="absolute bottom-5 flex w-full flex-col items-center">
          <Image
            src={HeroImage}
            alt="Hero Image"
            className="-ml-4 h-[310px] sm:-mb-20 sm:h-[400px] lg:-mb-28 lg:h-auto lg:w-[70%] xl:w-[70%]"
          />
